...
#  GPO  2 sets the registry to Disable LDAP Signing 
...
Set-GPPrefRegistryValue -Name "PROD | Enable LDAP Signing" -Context Computer -Key "HKLM\SYSTEM\CurrentControlSet\Services\NTDS\Parameters" -ValueName "LDAPServerIntegrity" -Value 2 -Type "DWORD" -Order 1 -Action "Update"
